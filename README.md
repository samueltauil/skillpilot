...
[![Skills Count](https://img.shields.io/badge/Skills-414-blue)](./site/src/data/skills.json)
...
|----------|:------:|-------------|
| ✨ Code Quality | 99 | Reviews, refactoring, linting |
...
| 🚀 DevOps & CI/CD | 33 | Pipelines, Docker, Kubernetes |
