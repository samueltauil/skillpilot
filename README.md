...
[![Skills Count](https://img.shields.io/badge/Skills-425-blue)](./site/src/data/skills.json)
...
|----------|:------:|-------------|
| ✨ Code Quality | 106 | Reviews, refactoring, linting |
| 📝 Documentation | 61 | READMEs, PRDs, technical writing |
...
| 🧪 Testing | 40 | Unit tests, E2E, test automation |
| 🚀 DevOps & CI/CD | 35 | Pipelines, Docker, Kubernetes |
