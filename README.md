...
[![Skills Count](https://img.shields.io/badge/Skills-385-blue)](./site/src/data/skills.json)
...
| 📝 Documentation | 58 | READMEs, PRDs, technical writing |
| 🔀 Git & Version Control | 53 | Commits, branching, GitHub operations |
| 🎨 Frontend & UI | 51 | React, Vue, components, design |
| 🔌 API & Backend | 42 | REST APIs, GraphQL, databases |
| 🧪 Testing | 36 | Unit tests, E2E, test automation |
| 🚀 DevOps & CI/CD | 28 | Pipelines, Docker, Kubernetes |
